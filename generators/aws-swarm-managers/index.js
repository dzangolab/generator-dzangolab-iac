...
export default class AWSSwarmManagersGenerator extends PulumiGenerator {
  constructor(args, opts) {
    super(args, opts);

    this.displayName = "AWS swarm managers";
    this.name = "swarm-managers";
    ...
    this.option("ami", {
      ...
      message: "What ami is used for swarm-managers (default: Amazon Linux 2023 64-bit (ARM))",
      name: "ami",
      required: true,
      type: String,
    });
    ...
    this.option("count", {
      type: String,
      default: "2",
      desc: "Number of managers nodes to provision"
    });
